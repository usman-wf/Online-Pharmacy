...
<div class="staff" id="staff">
  <!-- Person elements will be dynamically added here -->
  <div class="row">
    <div class="person engineer">
      <img src="Images\Professional-Headshot-Vancouver.jpeg" alt="Engineer"/>
      <p>Name: John Doe</p>
      <p>Role: Engineer</p>
    </div>
    <div class="person engineer">
      <img src="Images\Professional-Headshot-Vancouver (1).jpeg" alt="Engineer"/>
      <p>Name: Jane Smith</p>
      <p>Role: Engineer</p>
    </div>
    <div class="person conductor">
      <img src="designer.jpg" alt="Conductor"/>
      <p>Name: Sarah Johnson</p>
      <p>Role: Conductor</p>
    </div>
    <div class="person driver">
      <img src="manager.jpg" alt="Driver"/>
      <p>Name: John Poe</p>
      <p>Role: Driver</p>
    </div>
    <div class="person operator">
      <img src="manager.jpg" alt="Operator"/>
      <p>Name: John Foe</p>
      <p>Role: Operator</p>
    </div>
  </div>

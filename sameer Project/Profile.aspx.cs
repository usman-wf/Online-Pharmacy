...
namespace Railway_Management_System
{
    public partial class Profile : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                string query = "SELECT Schedule.RideID, BookingID , Arrival, Destination, TravelDate, TravelTime, Seats , Class FROM Schedule JOIN Booking ON Schedule.RideID = Booking.RideID WHERE TravellerID = @id ORDER BY TravelDate, TravelTime DESC";

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Railway_Management_System.Login" %>
...
<body>
    <form runat="server">
        <div class="container">
            ...
            <a href="Sign Up.aspx" class="signup-link">Create a new Account | Sign up</a>
        </div>
    </form>
</body>
</html>

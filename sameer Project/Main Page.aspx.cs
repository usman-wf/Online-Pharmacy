...
namespace Railway_Management_System
{
    public partial class Main_Page : BasePage
    {
        ...
        protected void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT TOP 5 Arrival, Destination, TravelDate, TravelTime, Available_Seats  FROM Schedule WHERE Destination = @Destination AND Arrival = @Arrival ORDER BY TravelDate, TravelTime";
        ...
        protected void ViewButton_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["sqlCon1"].ConnectionString;
            // Define your SQL query to select the top 5 schedules with the given destination
            string query = "SELECT TOP 5 Arrival, Destination, TravelDate, TravelTime, Available_Seats  FROM Schedule WHERE Destination = @Destination ORDER BY TravelDate, TravelTime";
        ...
        protected void ViewScheduleButton_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                string query = "SELECT TOP 5 Arrival, Destination , TravelDate , TravelTime , Available_Seats FROM Schedule WHERE TravelDate BETWEEN @StartDate AND @EndDate ORDER BY TravelDate DESC";
                SqlCommand command = new SqlCommand(query, connection);
